...
if __name__ == '__main__':
    video_path = '/home/liu/ForDeep/ForDeep/data/video/Cerealboxes2.mp4'  # 视频文件路径
    output_folder = '/home/liu/ForDeep/ForDeep/data/Cerealboxes2'  # 输出文件夹路径
