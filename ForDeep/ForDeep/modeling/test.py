...
for i in [0,21,26]:
    ...
    for ray in rays:
        ...
        lineset.colors = open3d.utility.Vector3dVector([[i / 26, 0, 0]])
        vis.add_geometry(lineset)

# 长方体边长
edge_lengths = [2.5, 2.5, 2.5]
# 长方体中心
# center = [-0.1, 0, 0.6]
center = [0.5, 0, 0.2]

# 创建坐标系
coord_frame = open3d.geometry.TriangleMesh.create_coordinate_frame(size=5, origin=[0, 0, 0])
